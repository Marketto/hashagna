    ...
    ***************************************************************************** */
    ...
    class HashagnaUtils {
        static newIframe() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return yield this.getIframe(id);
            });
        }
        static getIframe(id) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!iFrame) {
                    return yield new Promise(resolve => window.requestAnimationFrame(() => this.getIframe(id).then(resolve)));
                }
                return iFrame;
            });
        }
        static iframeLoadedContentWindow(iFrame) {
            return __awaiter(this, void 0, void 0, function* () {
                if (!iFrame.contentWindow) {
                    return yield new Promise(resolve => window.requestAnimationFrame(() => this.iframeLoadedContentWindow(iFrame).then(resolve)));
                }
        ...
        static iframeListenerInjector(iFrame) {
            return new Promise((resolve, reject) => {
                iFrame.onload = () => __awaiter(this, void 0, void 0, function* () {
                    const contentWindow = yield this.iframeLoadedContentWindow(iFrame);
    ...
    class HashagnaHttpClient {
        static get(url, queryParams) {
            return __awaiter(this, void 0, void 0, function* () {
                const iFrame = yield HashagnaUtils.newIframe();
